...
namespace ECommerceAPI.Controllers
{
    ...
    public class InitialController : ControllerBase
    {
        ...
        public ActionResult Initiate()
        {
            ...
            _produtoRepository.Cadastrar(new Produto() { Nome = "Notebook Gamer Acer", Preco = 3800.00m, Ativo = true, Descricao = "Notebook Gamer Acer", DataModificacao = DateTime.Now, IdUsuario = userFinal.Id });            
            _produtoRepository.Cadastrar(new Produto() { Nome = "Geladeira Samsung", Preco = 2858.25m, Ativo = false, Descricao = "Geladeira Samsung", DataModificacao = DateTime.Now, IdUsuario = userFinal2.Id });
            _produtoRepository.Cadastrar(new Produto() { Nome = "Liquidificador Philco", Preco = 1000.90m, Ativo = false, Descricao = "Liquidificador Philco", DataModificacao = DateTime.Now, IdUsuario = userFinal3.Id });
            _produtoRepository.Cadastrar(new Produto() { Nome = "Cama Box Baú King", Preco = 1500.00m, Ativo = true, Descricao = "Cama Box Baú King", DataModificacao = DateTime.Now, IdUsuario = userAdmin3.Id });
            _produtoRepository.Cadastrar(new Produto() { Nome = "Colchão King", Preco = 2200.89m, Ativo = true, Descricao = "Colchão King", DataModificacao = DateTime.Now, IdUsuario = userFinal2.Id });
