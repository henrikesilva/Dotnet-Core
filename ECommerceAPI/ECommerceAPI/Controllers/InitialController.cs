...
namespace ECommerceAPI.Controllers
{
    ...
    public class InitialController : ControllerBase
    {
        ...
        public ActionResult Initiate()
        {
            ...
            _produtoRepository.Cadastrar(new Produto() { Nome = "Notebook Gamer Acer", Preco = 3800.00m, Ativo = true, Descricao = "Notebook Gamer Acer", DataModificacao = DateTime.Now });            
            _produtoRepository.Cadastrar(new Produto() { Nome = "Geladeira Samsung", Preco = 2858.25m, Ativo = false, Descricao = "Geladeira Samsung", DataModificacao = DateTime.Now });
